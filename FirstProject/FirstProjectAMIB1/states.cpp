...
static const WireValue wire_values[2] = {
  ...
  {2, 0, sizeof(int32_t), (Value<void*>*) &ARM::rotations}
};

MasterManager<State, 3, 2> manager(0x2e7f4ef3, state_infos, wire_values, 0);
