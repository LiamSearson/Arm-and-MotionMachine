...
var ARM = {
  ...
  master: {
    values: {
      rotations: new HardwareValue(2, 0, Manager.TYPE_INT32)
    },
    events: {
      ...
      moveToTall: function moveToTall() { manager.sendEvent(8, 2); },
      moveToShort: function moveToShort() { manager.sendEvent(9, 2); },
      moveToPosition: function moveToPosition() { manager.sendEvent(10, 2); }
    }
  },
  tablet: {
    values: {
